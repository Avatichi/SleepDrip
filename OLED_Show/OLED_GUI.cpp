...
void GUI_Show(void)
{
  ...
  GUI_DisString_EN(30, 25, "WaveShare"   , &SUPPORT_FONT, FONT_BACKGROUND, WHITE);
  GUI_DisString_EN(28, 35, "Electronic"  , &SUPPORT_FONT, FONT_BACKGROUND, WHITE);
  GUI_DisString_EN(18, 45, "1.5inch OLED", &SUPPORT_FONT, FONT_BACKGROUND, WHITE);
